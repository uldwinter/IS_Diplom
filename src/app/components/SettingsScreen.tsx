...
import { changeCurrentUserPassword, getCurrentUser, getUserSettings, saveUserSettings, setScoringRules, updateCurrentUserProfile, useBackendState } from '@/app/backend/store';

export function SettingsScreen() {
  const { currentUserId, users, scoringRules } = useBackendState();
